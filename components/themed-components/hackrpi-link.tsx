...
export default function HackRPILink({
	...
	return (
		<NextLink
			href={href}
			className={`${className} group border-hackrpi-pink border-2 text-hackrpi-orange hover:bg-hackrpi-pink hover:text-hackrpi-yellow transition-colors duration-500 font-medium relative text-3xl`}
			target={target}
		>
			{children}
			<svg
